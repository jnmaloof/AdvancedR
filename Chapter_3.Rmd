...
_f2 reverses the order of the categories (and associated integers) in the vector.  f3 reverses the mapping (which factor levels is "first"), but not the order of categories in the vector.